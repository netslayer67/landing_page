...
function terms() {
  ...
  return (
    <section id="terms" className="pt-28  pb-0">
      <div className="container pb-20 ">
        <div className="w-full px-4">
          <div className="mx-auto mb-6 max-w-xl text-center">
            <h4 className="mt-4 mb-4 block text-4xl font-bold text-dark lg:text-5xl dark:text-white">
              Terms & Conditions
            </h4>
          </div>
        </div>
        <div className="flex flex-wrap ">
          <div className="p-4 w-full  px-4 lg:w-1/2 ">
            ...
            <div
              ...
              className="border-2 px-4 hidden py-4 max-h-[500px]  text-dark dark:text-secondary border-slate-300 shadow-lg rounded-md overflow-y-auto  w-full"
            >
            ...
            <div
              ...
              className="border-2 px-4 py-4  max-h-[500px] dark:text-secondary text-dark border-slate-300 shadow-lg rounded-md overflow-y-auto  w-full"
            >
          ...
          <div className="p-4 w-full px-4 lg:w-1/2  ">
            ...
            <div
              id="p-term-indo"
              className="border-2 px-4 dark:text-secondary py-4 max-h-[500px] text-dark border-slate-300 shadow-lg rounded-md overflow-y-auto  w-full"
            >
            ...
            <div
              id="p-term-egls"
              className="border-2 px-4 dark:text-secondary hidden py-4 max-h-[500px] text-dark border-slate-300 shadow-lg rounded-md overflow-y-auto  w-full"
            >
      ...
      <Script src=".\js\scriptterm.js"></Script>
    </section>
  );
}
