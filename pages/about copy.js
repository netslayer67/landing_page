      ...
      <div className="container">
        <div className="flex flex-wrap">
          <div className="mb-10 w-full px-4 lg:w-1/2">
            {/* <h1 className="mb-3 text-lg font-bold text-primary">About us</h1> */}
            <h1 className="text-base font-semibold dark:text-secondary text-primary md:text-2xl">
              About us
            </h1>
            <h2 className="mb-5 max-w-md mt-4 text-3xl dark:text-secondary font-bold text-dark lg:text-4xl">
              What we do
            </h2>
            <p className="max-w-xl text-base font-medium text-dark lg:text-lg dark:text-secondary">
              The DAISI platform leverages popular messaging applications such
              as Whatsapp to provide the most engaging marketing promotions or
              virtual event
            </p>
          </div>
          <div className="w-full px-4 lg:w-1/2">
            ...
            <p className="mb-6 text-base font-medium text-dark dark:text-secondary lg:text-lg">
              ...
              architecto dolores eos incidunt numquam iste doloribus aut
              similique!
            </p>
