// import portfolioImage1 from "../public/img/founder/b.png";
...
import portoImage4 from "../public/img/portfolio/image4.jpg"
    ...
    <section id="about" className="h-full relative">
      <div className="flex flex-col h-full w-full">
        ...
        <div className="flex w-full relative justify-around items-center h-1/2 text-white py-10">
          ...
          <div className="w-1/2">
            <h2>
              <span className="block text-xl md:text-xl text-black dark:text-secondary lg:text-6xl ">
                Followers Aren&apos;t
              </span>
              ...
              <span className="block mt-6 text-sm md:text-base text-black dark:text-secondary lg:text-4xl">
                WhatsApp contacts generate higher <br /> loyalty and LTV from customers than <br /> Social Media Ads or e-mail alone.
              </span>
            </h2>
          </div>
...
//   <h3 className="mb-4 text-2xl font-semibold dark:text-secondary text-black lg:w-1/2 lg:pt-10">
