...
import CompanyImage from "/public/img/Timkadologo.png";
...
export default function NavBar() {
  ...
  return (
    <header className="absolute border-b-2 top-0 left-0 z-10 flex w-full items-center bg-primary ">
      <div className="container bg-primary ">
        <div className=" borelative flex items-center  justify-between">
          <div className="px-4 ml-7">
            <a
              href="#home"
